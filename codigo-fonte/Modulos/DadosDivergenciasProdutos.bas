...
Dim i As Long
    ...
    With CamposProduto
        ...
        .VL_ABAT_NT_NF = fnExcel.ConverterValores(Campos(dicTitulosProdutos("VL_ABAT_NT_NF")), True, 2)
        .VL_ABAT_NT_SPED = fnExcel.ConverterValores(Campos(dicTitulosProdutos("VL_ABAT_NT_SPED")), True, 2)
...
Dim i As Long
    ...
    With CamposProduto
        ...
        Campos(dicTitulosProdutos("VL_ABAT_NT_NF") - i) = .VL_ABAT_NT_NF
        Campos(dicTitulosProdutos("VL_ABAT_NT_SPED") - i) = .VL_ABAT_NT_SPED
