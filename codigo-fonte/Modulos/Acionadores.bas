...
Dim Status As String
    ...
    'Registra acionamento de bot�o do usu�rio
    ...
    Select Case control.id
        ...
        Case "btnAutenticarUsuario"
            If EmailAssinante <> "" And Not Funcoes.ValidarEmail(EmailAssinante) Then
                ...
                MsgBox "Informe um e-mail v�lido para autenticar sua assinatura.", vbExclamation, "Email n�o informado ou inv�lido"
    ...
    If NivelPlano >= 1 Then
        ...
        Select Case control.id
            ...
            Case "btnImportarSPEDFiscal"
                ...
                'Dim ImportadorFiscal As New clsImportadorSPED
                'ImportadorFiscal.Tipo = spFiscal
                'ImportadorFiscal.Importar "Arquivo" ' ou "Lote"
                GoTo Sair:
...
'Controles A100
            ...
            Case "btnIdentificarC170Ausentes"
                Call rC170.C100SemFilhos.FiltrarC100SemFilhos
                GoTo Sair:
    ...
    Else
        ...
        Msg = "O seu n�vel de assinatura n�o d� acesso a esta funcionalidade." & vbCrLf & vbCrLf
        Msg = Msg & "Com o plano B�sico, voc� desbloqueia o acesso aos recursos para trabalhar com os arquivos do SPED Fiscal." & vbCrLf & vbCrLf
        Msg = Msg & "Clique em SIM para fazer o upgrade do seu plano agora mesmo!"
        
        vbResult = MsgBox(Msg, vbExclamation + vbYesNo, "Necess�rio Upgrade de Plano")
    ...
    If NivelPlano >= 2 Then
        ...
        Select Case control.id
            ...
            Case "btnImportarSPEDContribuicoes"
                ...
                'Dim ImportadorContrib As New clsImportadorSPED
                'ImportadorContrib.Tipo = spContribuicoes
                'ImportadorContrib.Importar "Arquivo"
                GoTo Sair:
    ...
    Else
        ...
        Msg = "O seu n�vel de assinatura n�o d� acesso a esta funcionalidade." & vbCrLf & vbCrLf
        Msg = Msg & "Com o plano Plus, voc� desbloqueia o acesso aos recursos para trabalhar com os arquivos do SPED Contribui��es." & vbCrLf & vbCrLf
        Msg = Msg & "Clique em SIM para fazer o upgrade do seu plano agora mesmo!"
...
'##----->> Bot�es de acesso aos Relat�rios Inteligentes
...
'##----->> Funcionalidades do Assistente de Apura��o do ICMS
            ...
            Case "btnListarNotasICMS"
                Call Util.FiltrarRegistros(assApuracaoICMS, relDivergenciasNotas, "CHV_NFE", "CHV_NFE")
                GoTo Sair:
                
            Case "btnListarItensICMS"
                Call Util.FiltrarRegistros(assApuracaoICMS, relDivergenciasProdutos, Array("CHV_NFE", "CFOP"), Array("CHV_NFE", "CFOP_SPED"))
                GoTo Sair:
...
'##----->> Funcionalidades do Assistente de Apura��o do IPI
...
'##----->> Funcionalidades do Assistente de Apura��o do PIS e COFINS
...
'##----->> Funcionalidades do Assistente de Diverg�ncias de Notas
...
'##----->> Funcionalidades do Assistente de Diverg�ncias de Produtos
...
'##----->> Funcionalidades do Assistente de Tributa��o do ICMS
            ...
            Case "btnExportarTributacaoICMS"
                Call Util.ExportarDadosRelatorio(assTributacaoICMS, "Tributa��o ICMS")
                GoTo Sair:
                
            Case "btnGerarModTributacaoICMS"
                Call Util.GerarModeloRelatorio(assTributacaoICMS, "Tributa��o ICMS")
                GoTo Sair:
...
'##----->> Funcionalidades do Assistente de Tributa��o do IPI
            ...
            Case "btnExportarTributacaoIPI"
                Call Util.ExportarDadosRelatorio(assTributacaoIPI, "Tributa��o PIS-COFINS")
                GoTo Sair:
                
            Case "btnGerarModTributacaoIPI"
                Call Util.GerarModeloRelatorio(assTributacaoIPI, "Tributa��o PIS-COFINS")
                GoTo Sair:
...
'##----->> Funcionalidades do Assistente de Tributa��o do PIS/COFINS
            ...
            Case "btnExportarTributacaoPISCOFINS"
                Call Util.ExportarDadosRelatorio(assTributacaoPISCOFINS, "Tributa��o PIS-COFINS")
                GoTo Sair:
                
            Case "btnGerarModTributacaoPISCOFINS"
                Call Util.GerarModeloRelatorio(assTributacaoPISCOFINS, "Tributa��o PIS-COFINS")
                GoTo Sair:
...
'##----->> Funcionalidades do Assistente de Apura��o de Assistente de Custos e Pre�os
            Case "btnGerarCustosPrecos"
                Call FuncoesAssistentesInteligentes.GerarRelatorioCustosPrecos
                GoTo Sair:
                
'##----->> Funcionalidades do Assistente de Apura��o de Estoque
...
'##----->> Funcionalidades do Assistente de Apura��o de Contas
...
'##----->> Funcionalidades do Assistente de Invent�rio
...
'##----->> Funcionalidades do Analista de Apura��o do ICMS
...
'##----->> Funcionalidades do Analista de Apura��o do PIS e COFINS
    ...
    Else
        ...
        Msg = "O seu n�vel de assinatura n�o d� acesso a esta funcionalidade." & vbCrLf & vbCrLf
        Msg = Msg & "Com o plano Premium, voc� desbloqueia o acesso a todas as nossas funcionalidades de relat�rios inteligentes e maximiza sua produtividade." & vbCrLf & vbCrLf
        Msg = Msg & "Clique em SIM para fazer o upgrade do seu plano agora mesmo!"
...
'##----->> Bot�es de acesso aos recursos do plano Enterprise
        Select Case True
...
'##----->> Funcionalidades do Assistente Anal�tico de Movimenta��o de Estoque
            Case "btnGerarAnaliseEstoque"
                Call Estoque.GerarRelatorioMovimentacaoEstoque
                GoTo Sair:
                
'##----->> Funcionalidades do Auditor de Invent�rio
            Case "btnGerarSaldoInventario"
                Call Inventario.GerarRelatorioSaldoInventario
                GoTo Sair:
                
'##----->> Funcionalidades do Assistente de Recupera��o do ICMS-ST
            Case "btnGerarRelatorioExclusaoICMSST"
                Call ExclusaoICMSST.GerarRelatorioRecuperacaoICMSST
                GoTo Sair:
            
            Case "btnCalcularCreditoPresumidoICMSST"
                Call ExclusaoICMSST.CalcularCreditoPresumidoICMSST
                GoTo Sair:
                
            Case "btnAtualizarRegistrosExclusaoICMSST"
                Call ExclusaoICMSST.AtualizarRegistros
                GoTo Sair:
                
'##----->> Funcionalidades do Assistente de Recupera��o do ICMS
            Case "btnGerarRelatorioExclusaoICMS"
                Call ExclusaoICMS.GerarRelatorioExclusaoICMS
                GoTo Sair:
            
            Case "btnCalcularCreditoPresumidoICMS"
                Call ExclusaoICMS.CalcularExclusaoICMSNormal
                GoTo Sair:
                
            Case "btnAtualizarRegistrosExclusaoICMS"
                Call ExclusaoICMS.AtualizarRegistros
                GoTo Sair:
    ...
    Else
        ...
        Msg = "O seu n�vel de assinatura n�o d� acesso a esta funcionalidade." & vbCrLf & vbCrLf
        Msg = Msg & "Com o plano Enterprise, voc� desbloqueia o acesso a todas as nossas funcionalidades para maximizar sua produtividade, diversificar seus servi�os e aumentar sua lucratividade." & vbCrLf & vbCrLf
        Msg = Msg & "Clique em SIM para fazer o upgrade do seu plano agora mesmo!"
...
Dim Msg As String
    ...
    If Status <> "ACTIVE" Then
        ...
        Select Case True
            ...
            Case Status = ""
                Msg = "Assinatura n�o identificada!" & vbCrLf & vbCrLf
                Msg = Msg & "Por favor, fa�a a autentica��o para continuar aproveitando uma rotina mais r�pida, pr�tica e segura."
                Call Util.MsgAlerta(Msg, "Assinatura N�o Identificada")
        
            Case Status = "INACTIVE"
                Msg = "Assinatura Inativa!" & vbCrLf & vbCrLf
                Msg = Msg & "A sua assinatura est� inativa, renove sua assinatura para continuar aproveitando uma rotina mais r�pida, pr�tica e segura."
                Call Util.MsgAlerta(Msg, "Assinatura Inativa")
        
            Case Status = "DELAYED"
                Msg = "Assinatura Atrasada!" & vbCrLf & vbCrLf
                Msg = Msg & "A sua assinatura est� atrasada, renove sua assinatura para continuar aproveitando uma rotina mais r�pida, pr�tica e segura."
                Call Util.MsgAlerta(Msg, "Assinatura Atrasada")
            
            Case Status = "FINISH"
                Msg = "Assinatura Finalizada!" & vbCrLf & vbCrLf
                Msg = Msg & "A sua assinatura est� finalizada, renove sua assinatura para continuar aproveitando uma rotina mais r�pida, pr�tica e segura."
                Call Util.MsgAlerta(Msg, "Assinatura Inativa")
            
            Case Status Like "CANCELLED"
                Msg = "Assinatura Cancelada!" & vbCrLf & vbCrLf
                Msg = Msg & "A sua assinatura est� Cancelada, fa�a a renova��o para continuar aproveitando uma rotina mais r�pida, pr�tica e segura."
