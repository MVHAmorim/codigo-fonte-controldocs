...
Dim dicDadosH001 As New Dictionary
...
Dim Reiniciado As Boolean
    ...
    Set dicTitulosH001 = Util.MapearTitulos(regH001, 3)
    Set dicDadosH001 = Util.CriarDicionarioRegistro(regH001, "ARQUIVO")
    ...
    For Each Linha In Dados.Rows
        ...
        Call Util.AntiTravamento(a, 50, "Preparando dados para atualização do SPED, por favor aguarde...", Dados.Rows.Count, Comeco)
    ...
    Application.StatusBar = "Atualizando dados do registro H001, por favor aguarde..."
    Call Util.ExportarDadosDicionario(regH001, dicDadosH001)
