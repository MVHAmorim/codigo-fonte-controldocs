...
Sub ForcarErro()
    ' For�a um erro personalizado com c�digo de erro 9999
    Err.Raise 9999, "ForcarErro", "Este � um erro for�ado para testar a rotina"
End Sub
...
Sub getClique(control As IRibbonControl, ByRef Check)
    ...
    Select Case True
        ...
        'TODO: CRIAR CHECKBOX PARA IMPORTAR APENAS NOTAS DE EMISS�O PR�PRIA NOS XMLS
...
MsgBox "O registro informado est� inv�lido!" & vbCrLf & _
       "Por favor verifique o registro digitado e tente novamente.", _
       vbExclamation, "Registro Inv�lido"
    ...
    With ActiveSheet
        ...
        Select Case True
            ...
            Case (.CodeName = "Divergencias")
                If control.Tag = "Diverg�ncias Fiscais" Then visible = True
            ...
            Case (.CodeName = "Autenticacao")
                If control.Tag = "Autentica��o" Then visible = True
            
            Case (.CodeName = "Correlacoes")
                If control.Tag = "Correla��o Produtos" Then visible = True
                
            Case (.CodeName = "Tributacao")
                If control.Tag = "btnImportarItensSPED" Then visible = True
                
            Case (.CodeName = "assApuracaoICMS")
                If control.Tag = "An�lise Produtos" Then visible = True
            ...
            Case (.CodeName = "assTributacaoICMS")
                If control.Tag = "Assistente de Tributa��o ICMS" Then visible = True
            ...
            Case (.CodeName = "relCustosPrecos")
                If control.Tag = "Assistente de Custos e Pre�os" Then visible = True
            ...
            Case (.CodeName = "relInvent�rio")
                If control.Tag = "Assistente de Invent�rio" Then visible = True
