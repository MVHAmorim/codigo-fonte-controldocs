    ...
    With CamposCFOP
        ...
        If SPEDFiscal.dicDados0000.Exists(.Arquivo) Then
            ...
            If Not VBA.IsEmpty(Campos) Then
                ...
                IND_ATIV = Util.RemoverAspaSimples(Campos(SPEDFiscal.dicTitulos0000("IND_ATIV") - i))
